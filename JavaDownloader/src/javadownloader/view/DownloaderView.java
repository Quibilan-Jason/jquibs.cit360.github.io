...
public class DownloaderView extends javax.swing.JFrame implements DownloaderThread.DownloadListener {
    ...
    public DownloaderView() {
        initComponents();
        setLocationRelativeTo(null); //loads viewer center of screen
        setTitle("My Awesome Downloader!");
    }
    ...
    private void downloadBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_downloadBtnActionPerformed
        ...
        if(checkValidURL(url)) {            
            startDownload(url);            
            System.out.println("Brah! Start downloading");
        } else {
            System.err.println("Brah! NO can start");
        }
    ...
    public void onDownloadStart() {
        this.infoPanel.append("Brah, download started!\n");        
    }
    ...
    public void onDownloadComplete() {
        this.infoPanel.append("Brah, download done!\n");
    }

    @Override
    public void onDownloadFailed(String errorMsg) {
        this.infoPanel.append("Brah, da process failed! "+ errorMsg +" ...\n");
    }
    ...
    public String showSaveDialog(File fileToSave) {
        ...
        fileChooser.setDialogTitle("Brah, what directory to save " + fileToSave.getName());
